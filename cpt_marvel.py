...
vel_1 = np.array([vel[0] for vel in stars]).sum()
vel_2 = np.array([vel[1] for vel in stars]).sum()
vel_3 = np.array([vel[2] for vel in stars]).sum()
...
#total_v =np.array([Av_vel_1, Av_vel2, Av_vel3])
